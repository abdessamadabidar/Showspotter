...
export default function AnimePage() : JSX.Element {
	...
	return (
		...
		<section className={"w-screen overflow-hidden"}>
			...
			<div className={"w-full px-5 xl:w-[85%] 2xl:w-[75%] mx-auto my-24"}>
				<div className={"mb-16"}>
				...
				<div className="flex flex-col gap-y-8 ">
					<div className="flex flex-col items-center justify-center md:flex-row md:justify-between gap-5 pb-5 border-b-0.1 border-b-smooth-gray">
						<h2 className="font-semibold text-3xl">Anime</h2>
						<div className=" border-1 bg-gray-800 border-smooth-gray ps-2 pe-3 flex flex-nowrap items-center rounded-lg ">
							<svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24"><g fill="none" stroke="#9CA3AF"><circle cx="11" cy="11" r="6"/><path strokeLinecap="round" d="m20 20l-3-3"/></g></svg>
							<input type="text" name="searchQuery" className={"bg-transparent font-light w-full h-full ms-2 py-[0.5rem] !border-0 outline-0 "} placeholder={"search"} />
						</div>
					</div>
					<div className="gap-2 grid grid-cols-3 md:grid-cols-4 lg:grid-cols-3 xl:grid-cols-7 ">
						{movies.map((link : string, index: number) =>
							(
								<Card className="sm:w-[115px] sm:h-[171px] md:w-[178px] md:h-[267px] lg:w-[314px] lg:h-[475px] xl:w-[150px] xl:h-[225px]" key={index} isPressable>
									<Image
										removeWrapper
										alt="Card background"
